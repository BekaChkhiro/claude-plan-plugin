...
/settings language             # Change language preference (global)
/settings language --local     # Change language for this project only
/settings reset                # Reset global settings to defaults
