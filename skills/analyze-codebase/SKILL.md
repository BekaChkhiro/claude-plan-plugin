...
- User runs `/plan:new` in a directory with existing code
...
3. Run `/plan:new` and reference this analysis
...
### Step 8: Integration with /plan:new

When invoked during `/plan:new`:
1. Run full analysis
...
💡 Next steps:
   ...
   2. Run /plan:new to create improvement plan
